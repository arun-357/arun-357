...
- **[AgentHub](https://github.com/arun-357/agenthub)** –  
...
- **[Shortest Path Visualizer](https://shortest-path-visualizer-blue.vercel.app/)** –  
  *Visualizes 6 pathfinding algorithms (BFS, Dijkstra, A\*, Greedy, DFS, Bidirectional) with frame-by-frame playback, maze generators, and side-by-side comparison.*  
